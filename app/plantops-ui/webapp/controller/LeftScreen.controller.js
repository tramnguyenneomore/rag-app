sap.ui.define([
    ...
    return Controller.extend("plantopsassistant.controller.LeftScreen", {
        ...
        onUploadCompleted: function (oEvent) {
            ...
            // Add small delay to ensure backend processing is complete, then refresh again
            setTimeout(() => {
                oUploadSetWithTable.getBinding("items").refresh();
                MessageToast.show("File uploaded successfully! Embeddings are being generated automatically.");
            }, 1000);
            
            // Note: Embeddings are automatically generated by the backend 'after CREATE' hook
            // No manual triggering needed - the backend handles this automatically when a file is created
        },
